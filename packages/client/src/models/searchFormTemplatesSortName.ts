...
export type SearchFormTemplatesSortName = typeof SearchFormTemplatesSortName[keyof typeof SearchFormTemplatesSortName];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SearchFormTemplatesSortName = {
  asc: 'asc',
  desc: 'desc',
} as const;
