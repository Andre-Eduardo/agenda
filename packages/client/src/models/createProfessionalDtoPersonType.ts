...
export type CreateProfessionalDtoPersonType = typeof CreateProfessionalDtoPersonType[keyof typeof CreateProfessionalDtoPersonType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProfessionalDtoPersonType = {
  NATURAL: 'NATURAL',
  LEGAL: 'LEGAL',
} as const;
