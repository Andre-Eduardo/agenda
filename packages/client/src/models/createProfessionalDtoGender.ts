 ...
 * @nullable
 */
export type CreateProfessionalDtoGender = typeof CreateProfessionalDtoGender[keyof typeof CreateProfessionalDtoGender] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProfessionalDtoGender = {
  MALE: 'MALE',
  FEMALE: 'FEMALE',
  OTHER: 'OTHER',
} as const;
