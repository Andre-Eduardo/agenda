...
export type AppointmentPaymentPaymentMethod = typeof AppointmentPaymentPaymentMethod[keyof typeof AppointmentPaymentPaymentMethod];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AppointmentPaymentPaymentMethod = {
  CASH: 'CASH',
  PIX: 'PIX',
