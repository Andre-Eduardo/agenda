...
export type DocumentPermissionEntityType = typeof DocumentPermissionEntityType[keyof typeof DocumentPermissionEntityType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DocumentPermissionEntityType = {
  RECORD: 'RECORD',
  FILE: 'FILE',
