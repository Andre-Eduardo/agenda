 ...
 */
import type { CreateFormTemplateVersionInputDtoDefinitionJsonSectionsItemFieldsItemUiWidth } from './createFormTemplateVersionInputDtoDefinitionJsonSectionsItemFieldsItemUiWidth';

export type CreateFormTemplateVersionInputDtoDefinitionJsonSectionsItemFieldsItemUi = {
  width?: CreateFormTemplateVersionInputDtoDefinitionJsonSectionsItemFieldsItemUiWidth;
  hint?: string;
  tooltip?: string;
};
