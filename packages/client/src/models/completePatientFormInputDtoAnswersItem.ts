 ...
 */
import type { CompletePatientFormInputDtoAnswersItemValueJson } from './completePatientFormInputDtoAnswersItemValueJson';

export type CompletePatientFormInputDtoAnswersItem = {
  /** @minLength 1 */
  fieldId: string;
  /** @nullable */
  ...
  /** @nullable */
  valueJson?: CompletePatientFormInputDtoAnswersItemValueJson;
};
