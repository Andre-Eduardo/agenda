...
export const patientCard = {
    root: cn(
        'mt-4 flex items-center gap-3 rounded-(--radius-card) border border-(--color-border) bg-(--color-bg-card) px-4 py-[10px]'
    ),
    info: cn('min-w-0'),
    name: cn(
        'cursor-pointer text-[14px] font-medium text-(--color-text-primary) transition-colors hover:text-(--color-primary-text)'
    ),
...
export const layout = {
    ...
    tocFoot: cn(
        'mt-2 flex items-center gap-[6px] border-t border-(--color-border) px-[10px] pt-2 text-[11px] text-(--color-text-tertiary)'
    ),
    content: cn('min-w-0'),
};
...
export const section = {
    root: cn(
        'mb-[18px] rounded-[12px] border border-(--color-border) bg-(--color-bg-card) px-[24px] pb-[24px] pt-[22px]'
    ),
    head: cn('mb-[18px] flex items-start gap-3 border-b border-dashed border-(--color-border) pb-[14px]'),
    icon: cn(
        'inline-flex size-[28px] shrink-0 items-center justify-center rounded-[8px] bg-(--color-primary-surface) text-(--color-primary-text)'
    ),
...
export const vitals = {
    ...
    prevToggle: cn(
        'inline-flex cursor-pointer items-center gap-1 border-0 bg-transparent text-[12px] text-(--color-text-secondary) hover:text-(--color-primary-text)'
    ),
...
export const soap = {
    ...
    letter: cva('inline-flex size-[26px] shrink-0 items-center justify-center rounded-[6px] text-[13px] font-medium', {
        variants: {
            v: {
    ...
    vitalsRef: cn(
        'mb-2 flex flex-wrap items-center gap-[6px] rounded-[6px] bg-(--color-bg-surface) px-3 py-[6px] text-[12px] text-(--color-text-secondary)'
    ),
    textarea: cn(
...
export const upload = {
    ...
    row: cn(
        'flex items-center gap-3 rounded-[8px] border border-(--color-border) bg-(--color-bg-surface) px-3 py-[10px]'
    ),
    ...
    remove: cn(
        'flex size-7 cursor-pointer items-center justify-center rounded-[6px] border-0 bg-transparent text-(--color-text-tertiary) transition-colors hover:bg-(--color-bg-card) hover:text-(--color-danger)'
    ),
...
export const modal = {
    ...
    panel: cn(
        'w-[420px] max-w-[calc(100vw-32px)] rounded-[16px] border border-(--color-border) bg-(--color-bg-card) p-6 shadow-xl'
    ),
    ...
    summary: cn(
        'mb-5 divide-y divide-(--color-border) overflow-hidden rounded-[8px] border border-(--color-border) bg-(--color-bg-surface)'
    ),
    ...
    chip: cn(
        'inline-flex items-center gap-1 rounded-(--radius-badge) bg-(--color-primary-surface) px-[6px] py-[2px] text-[11px] font-medium text-(--color-primary-text)'
    ),
