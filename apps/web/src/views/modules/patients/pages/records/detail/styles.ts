...
export const header = {
  root: cn('mb-[22px] grid grid-cols-[1fr_auto] items-start gap-7 rounded-[14px] border border-(--color-border) bg-(--color-bg-card) px-[26px] py-[22px]'),
...
export const section = {
  ...
  title: cn('flex items-center gap-2 text-[15px] font-medium leading-[1.3] tracking-[-0.01em] text-(--color-text-primary)'),
  sub: cn('mt-[3px] text-[12px] text-(--color-text-tertiary)'),
  traceRoot: cn('relative rounded-[12px] border border-(--color-border) bg-(--color-bg-card) pb-[24px] pl-[32px] pr-[26px] pt-[22px]'),
...
export const soap = {
  ...
  letter: cva(
    'inline-flex size-9 shrink-0 items-center justify-center rounded-[8px] text-[15px] font-medium',
    {
      variants: {
        v: {
...
export const files = {
  ...
  row: cn('grid grid-cols-[36px_1fr_auto] items-center gap-[14px] border-b border-(--color-border) px-4 py-3 last:border-0'),
  icon: cn('flex size-9 shrink-0 items-center justify-center rounded-[8px] bg-(--color-bg-card) text-(--color-text-secondary)'),
