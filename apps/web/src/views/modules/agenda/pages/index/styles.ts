...
export const weekHead = cn(
  'sticky top-0 z-10 flex border-b border-(--color-border) bg-(--color-bg-card)',
);
...
export const timeRow = cn(
  'flex items-start justify-end border-t border-(--color-border)/40 pr-2 first:border-t-0',
);
export const timeLbl = cn('text-[10px] tabular-nums text-(--color-text-tertiary) -mt-[6px]');

export const dayCol = cva(
  'relative flex-1 border-l border-(--color-border)/40 first:border-l-0',
  {
    variants: {
...
export const dayViewHead = cn(
  'border-b border-(--color-border) bg-(--color-bg-card) px-6 py-4',
);
...
export const monthHead = cn(
  'grid grid-cols-7 border-b border-(--color-border) bg-(--color-bg-card)',
);
...
export const shHead = cn(
  'flex shrink-0 items-center justify-between border-b border-(--color-border) px-5 py-4',
);
...
export const shFoot = cn(
  'flex shrink-0 items-center justify-end gap-2 border-t border-(--color-border) px-5 py-4',
);
...
export const shPatientCard = cn(
  'flex items-start gap-3 rounded-(--radius-card-sm) bg-(--color-bg-surface) p-3',
);
...
export const shHistTag = cn('rounded-full bg-(--color-bg-surface) px-2 py-0.5 text-[10px] text-(--color-text-secondary)');
...
export const shHistLink = cn(
  'flex items-center gap-1 text-xs text-(--color-primary-text) hover:underline',
);
