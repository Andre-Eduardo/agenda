...
export const alertsBar = cn(
  'rounded-(--radius-card) border border-(--color-warning)/30 bg-(--color-warning)/5 p-4',
);
export const alertsHead = cn(
  'flex items-center gap-2 text-sm font-medium text-(--color-warning) mb-3',
);
export const alertsList = cn('flex flex-col gap-2');
export const alertRow = cva(
  'flex items-start gap-3 rounded-[6px] p-3',
  {
    variants: {
      tone: {
...
export const statIcon = cva(
  'flex items-center justify-center w-9 h-9 rounded-[8px] shrink-0',
  {
    variants: {
      tone: {
...
export const statValue = cn(
  'text-2xl font-medium text-(--color-text-primary) font-mono tabular-nums leading-none',
);
...
export const sectionHead = cn(
  'flex items-center justify-between gap-4 px-5 pt-5 pb-4',
);
...
export const apptTimeStart = cn(
  'text-sm font-medium font-mono tabular-nums text-(--color-text-primary) leading-none',
);
export const apptTimeEnd = cn(
  'text-[11px] text-(--color-text-tertiary) font-mono tabular-nums mt-0.5',
);
export const apptPatBtn = cn(
  'flex items-center gap-2.5 flex-1 min-w-0 hover:opacity-75 transition-opacity text-left',
);
export const apptPatName = cn(
  'text-sm font-medium text-(--color-text-primary) truncate leading-none',
);
export const apptPatType = cn(
  'flex items-center gap-1 text-[11px] text-(--color-text-tertiary) mt-0.5',
);
