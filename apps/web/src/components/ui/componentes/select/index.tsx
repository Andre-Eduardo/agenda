...
function SelectScrollUpButton({className, ref, ...props}: React.ComponentProps<typeof SelectPrimitive.ScrollUpButton>) {
    return (
        <SelectPrimitive.ScrollUpButton ref={ref} className={clsx(styles.selectScrollButton, className)} {...props}>
...
function SelectScrollDownButton({
    ...
    return (
        <SelectPrimitive.ScrollDownButton ref={ref} className={clsx(styles.selectScrollButton, className)} {...props}>
    ...
    return (
        <SelectPrimitive.Portal>
            <SelectPrimitive.Content
                ref={ref}
                className={clsx(styles.selectContent, position === 'popper' && styles.selectContentPopper, className)}
                position={position}
                {...props}
            >
                <SelectScrollUpButton />
                <SelectPrimitive.Viewport
                    className={clsx(styles.selectViewport, position === 'popper' && styles.selectViewportPopper)}
                >
                    {children}
                </SelectPrimitive.Viewport>
...
function SelectLabel({className, ref, ...props}: React.ComponentProps<typeof SelectPrimitive.Label>) {
    return <SelectPrimitive.Label ref={ref} className={clsx(styles.selectLabel, className)} {...props} />;
}
...
function SelectSeparator({className, ref, ...props}: React.ComponentProps<typeof SelectPrimitive.Separator>) {
    return <SelectPrimitive.Separator ref={ref} className={clsx(styles.selectSeparator, className)} {...props} />;
}
