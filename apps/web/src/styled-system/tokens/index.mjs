const tokens = {
  ...
  "fontSizes.sm-body": {
    "value": "14px",
    "variable": "var(--font-sizes-sm-body)"
  },
  "fontSizes.base": {
    "value": "16px",
  ...
  "fontSizes.sub": {
    "value": "16px",
    "variable": "var(--font-sizes-sub)"
  },
  "fontSizes.lead": {
    "value": "18px",
    "variable": "var(--font-sizes-lead)"
  },
  "fontSizes.xl": {
    "value": "24px",
  ...
  "radii.card-sm": {
    "value": "10px",
    "variable": "var(--radii-card-sm)"
  },
  "radii.button": {
    "value": "8px",
    "variable": "var(--radii-button)"
  },
  "radii.input": {
    "value": "8px",
  ...
  "spacing.padding-card": {
    "value": "16px",
    "variable": "var(--spacing-padding-card)"
  },
  "spacing.padding-section": {
    "value": "12px",
    "variable": "var(--spacing-padding-section)"
  },
  "spacing.padding-data-block": {
    "value": "10px",
    "variable": "var(--spacing-padding-data-block)"
  },
  "spacing.gap-elements": {
    "value": "12px",
    "variable": "var(--spacing-gap-elements)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.border.hover": {
    "value": "var(--colors-border-hover)",
    "variable": "var(--colors-border-hover)"
  },
  "colors.text.primary": {
  ...
  "colors.primary.surface": {
    "value": "var(--colors-primary-surface)",
    "variable": "var(--colors-primary-surface)"
  },
  ...
  "colors.ai.bg": {
    "value": "var(--colors-ai-bg)",
    "variable": "var(--colors-ai-bg)"
  },
  "colors.ai.border": {
    "value": "var(--colors-ai-border)",
    "variable": "var(--colors-ai-border)"
  },
  "colors.ai.text": {
    "value": "var(--colors-ai-text)",
    "variable": "var(--colors-ai-text)"
  },
  "colors.ai.badgeBg": {
    "value": "var(--colors-ai-badge-bg)",
    "variable": "var(--colors-ai-badge-bg)"
  },
  "colors.ai.badgeText": {
    "value": "var(--colors-ai-badge-text)",
    "variable": "var(--colors-ai-badge-text)"
  },
  "colors.success": {
  ...
  "colors.success.surface": {
    "value": "var(--colors-success-surface)",
    "variable": "var(--colors-success-surface)"
  },
  "colors.warning": {
  ...
  "colors.danger.surface": {
    "value": "var(--colors-danger-surface)",
    "variable": "var(--colors-danger-surface)"
  },
  "colors.info": {
  ...
  "colors.confidence.high": {
    "value": "var(--colors-confidence-high)",
    "variable": "var(--colors-confidence-high)"
  },
  "colors.confidence.mid": {
    "value": "var(--colors-confidence-mid)",
    "variable": "var(--colors-confidence-mid)"
  },
  "colors.confidence.low": {
    "value": "var(--colors-confidence-low)",
    "variable": "var(--colors-confidence-low)"
  },
  "colors.background": {
  ...
  "spacing.-padding-card": {
    "value": "calc(var(--spacing-padding-card) * -1)",
    "variable": "var(--spacing-padding-card)"
  },
  "spacing.-padding-section": {
    "value": "calc(var(--spacing-padding-section) * -1)",
    "variable": "var(--spacing-padding-section)"
  },
  "spacing.-padding-data-block": {
    "value": "calc(var(--spacing-padding-data-block) * -1)",
    "variable": "var(--spacing-padding-data-block)"
  },
  "spacing.-gap-elements": {
    "value": "calc(var(--spacing-gap-elements) * -1)",
    "variable": "var(--spacing-gap-elements)"
  },
  "colors.colorPalette": {
  ...
  "colors.colorPalette.badgeBg": {
    "value": "var(--colors-color-palette-badge-bg)",
    "variable": "var(--colors-color-palette-badge-bg)"
  },
  "colors.colorPalette.badgeText": {
    "value": "var(--colors-color-palette-badge-text)",
    "variable": "var(--colors-color-palette-badge-text)"
  },
  "colors.colorPalette.high": {
    "value": "var(--colors-color-palette-high)",
    "variable": "var(--colors-color-palette-high)"
  },
  "colors.colorPalette.mid": {
    "value": "var(--colors-color-palette-mid)",
    "variable": "var(--colors-color-palette-mid)"
  },
  "colors.colorPalette.low": {
    "value": "var(--colors-color-palette-low)",
    "variable": "var(--colors-color-palette-low)"
  }
}
