Feature: Approve inspection
    As a user, I want to approve an inspection so that a room can be available for a customer to rent

    Background:
        Given a company with name "Ecxus" exists
        And the following employees with system access in the company "Ecxus" exist:
            | User     | Permissions          |
            | john-doe | [inspection:approve] |
            | anaa123  | []                   |
    ...
    Scenario: Preventing unauthorized users from approving an inspection
        Given I am signed in as "anaa123" in the company "Ecxus"
        When I send a "PATCH" request to "/inspection/room/${ref:id:room:Ecxus:456}/approve" with:
            | finishedById | ${ref:id:user:john-doe} |
            | note         | Inspection approved     |
        Then I should receive an access denied error with reason INSUFFICIENT_PERMISSIONS

    Scenario: Approving an inspection
        ...
        And should exist inspections in the company "Ecxus" with the following data:
            ...
            | 456  | ${ref:id:user:john-doe} | ${ref:id:user:john-doe} | 2020-01-01T02:00:00Z | 2024-01-01T05:00:00Z | APPROVED   | 2020-01-01T02:00:00Z |
    ...
    Scenario Outline: Approving an inspection with invalid information
        Given the current date and time is "2024-01-01T05:00:00Z"
        And I am signed in as "john-doe" in the company "Ecxus"
        When I send a "PATCH" request to "/inspection/room/${ref:id:room:Ecxus:789}/approve" with:
            | <Field> | <Value> |
    ...
    Scenario: Approving an inspection that does not exist
        Given I am signed in as "john-doe" in the company "Ecxus"
        And "unknown-id" is defined as:
            """
            b937e300-3364-4c7d-b6ed-675deea6e89e
            """
        When I send a "PATCH" request to "/inspection/room/${ref:var:unknown-id}/approve" with:
            | finishedById | ${ref:id:user:john-doe} |
            | note         | Inspection approved     |
