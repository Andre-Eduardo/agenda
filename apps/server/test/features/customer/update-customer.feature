Feature: Update customer
    As a user, I want to update a customer so that I can keep the customer information up to date

    Background:
        Given a company with name "Ecxus" exists
        And the following employees with system access in the company "Ecxus" exist:
            | User       | Permissions       |
            | john_doe   | [customer:update] |
            | william123 | []                |
    ...
    Scenario: Preventing unauthorized users from updating a customer
        Given I am signed in as "william123" in the company "Ecxus"
        When I send a "PUT" request to "/customer/${ref:id:customer:Ecxus:10000000003}" with:
            | name        | Edu         |
            | phone       | "123456789" |
            | companyName | ACME        |
    ...
    Scenario: Updating a customer
        ...
        And the response should match:
            ...
            """
        Given should exist customers in the company "Ecxus" with the following data:
        ...
        And the following events in the company "Ecxus" should be recorded:
            ...
            | CUSTOMER_CHANGED | "2024-01-01T05:00:00Z" | "${ref:id:user:john_doe}" |

    Scenario Outline: Updating a customer with invalid information
        Given I am signed in as "john_doe" in the company "Ecxus"
        When I send a "PUT" request to "/customer/${ref:id:customer:Ecxus:10000000001}" with:
            | <Field> | <Value> |
