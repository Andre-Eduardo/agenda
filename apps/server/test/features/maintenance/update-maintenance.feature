Feature: Update maintenance
    As a user I want to update a maintenance so that I can keep my maintenance information up to date

    Background:
        Given a company with name "Ecxus" exists
        And the following employees with system access in the company "Ecxus" exist:
            | User       | Permissions          |
            | john_doe   | [maintenance:update] |
            | william123 | []                   |
        ...
        And the following maintenances exist in the company "Ecxus":
            ...
            | 1    | ${ref:id:user:john_doe} | 2024-01-01T01:00:00.000Z | 2024-01-01T01:00:00.000Z | 2024-01-01T01:00:00.000Z | Cleaning the room | ["${ref:id:defect:Ecxus:1:Door}"] |
    ...
    Scenario: Preventing unauthorized users from updating a maintenance
        Given I am signed in as "william123" in the company "Ecxus"
        When I send a "PUT" request to "/maintenance/${ref:id:maintenance:Ecxus:1}" with:
            | note | Automation is off |
        Then I should receive an access denied error with reason INSUFFICIENT_PERMISSIONS

    Scenario: Updating a maintenance
        ...
        And the following events in the company "Ecxus" should be recorded:
            ...
            | MAINTENANCE_CHANGED | "2024-01-06T04:00:00.000Z" | "${ref:id:user:john_doe}" |

    Scenario: Update maintenance with finished defects
    ...
    Scenario Outline: Updating a maintenance with invalid information
        Given I am signed in as "john_doe" in the company "Ecxus"
        When I send a "PUT" request to "/maintenance/${ref:id:maintenance:Ecxus:1}" with:
            | <Field> | <Value> |
    ...
    Scenario: Updating a maintenance that does not exist
        Given I am signed in as "john_doe" in the company "Ecxus"
        And "unknown-id" is defined as:
            """
            7f3c4fbe-bbb4-4c32-8cce-a68f3c992839
            """
        When I send a "PUT" request to "/maintenance/${ref:var:unknown-id}" with:
            | note | Automation is off |
