...
// eslint-disable-next-line import/no-unassigned-import -- required for NestJS decorators
...
// eslint-disable-next-line @typescript-eslint/no-floating-promises -- top-level async entry point
main();
