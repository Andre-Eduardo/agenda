 ...
 *
 * Ordem de execução:
 *   1. professional   — User + Person + ProfessionalConfig + Professional
 *   2. patients       — Pacientes vinculados ao profissional
 *   3. working-hours  — Horários de atendimento
 ...
 */
import {main as seedProfessional} from './seeds/professional.seed';
...
async function main() {
    ...
    console.log('--- [1/6] Profissional admin ---');
