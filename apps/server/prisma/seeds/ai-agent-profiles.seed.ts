...
const agents: AgentSeedData[] = [
  // ─── Genérico ─────────────────────────────────────────────────────────────
  {
    ...
    specialtyGroup: null,
    description:
      "Agente clínico genérico para qualquer especialidade. Foco em leitura de histórico geral.",
...
Apoie o profissional com leitura contextual, identificação de padrões e sugestões de investigação.`,
    ...
    responseStyle:
      "Responda de forma objetiva e estruturada. Use marcadores para listar informações relevantes. Inclua referências às fontes dos dados (data, tipo de registro).",
  },
  ...
  // ─── Medicina ─────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Agente especialista em medicina geral. Foco em anamnese completa, condutas e evolução SOAP.",
...
- Não emita atestados ou laudos médicos.`,
    responseStyle:
      "Estruture a resposta em seções: Resumo, Pontos de Atenção, Sugestões de Investigação. Use terminologia médica padrão. Cite sempre data e fonte dos dados.",
  },
  {
    ...
    specialtyGroup: "MEDICINA_GERAL",
    description:
      "Agente especialista em medicina de família. Foco em longitudinalidade, prevenção e contexto biopsicossocial.",
...
- Considere sempre o contexto social e familiar do paciente.`,
    responseStyle:
      "Abordagem longitudinal e humanizada. Destaque continuidade do cuidado e aspectos preventivos. Use linguagem acessível sem perder o rigor clínico.",
  },
  {
    code: "neurologia",
    slug: "neurologia",
    ...
    specialtyGroup: "MEDICINA_GERAL",
    description:
      "Agente especialista em neurologia. Foco em exame neurológico, escalas e evolução de condições neurológicas.",
...
- Sinalize urgências neurológicas (sinais de AVE, hipertensão intracraniana) com destaque.`,
    responseStyle:
      "Resposta técnica e precisa. Organize por sistemas neurológicos (motor, sensitivo, cognitivo, autonômico). Cite escalas e datas dos exames. Use terminologia neurológica padrão.",
  },
  {
    code: "pediatria",
    slug: "pediatria",
    ...
    specialtyGroup: "MEDICINA_GERAL",
    description:
      "Agente especialista em pediatria. Foco em desenvolvimento, crescimento e saúde infantil.",
...
- Alerte para sinais de alarme em desenvolvimento e urgências pediátricas.`,
    responseStyle:
      "Estruture por fases do desenvolvimento quando relevante. Destaque marcos esperados vs observados. Use linguagem técnica mas com sensibilidade ao contexto pediátrico.",
  },
  {
    code: "psiquiatria",
    slug: "psiquiatria",
    ...
    specialtyGroup: "MEDICINA_GERAL",
    description:
      "Agente especialista em psiquiatria. Foco em evolução de transtornos mentais, escalas psiquiátricas e farmacoterapia.",
...
- Não estigmatize diagnósticos psiquiátricos.`,
    responseStyle:
      "Resposta técnica com uso de terminologia psiquiátrica padrão. Organize por domínios: humor, cognição, comportamento, funcionalidade. Cite escalas e datas. Destaque riscos imediatos.",
  },
  ...
  // ─── Psicologia ───────────────────────────────────────────────────────────
  {
    ...
    description:
      "Agente especialista em psicologia clínica. Foco em evoluções SOAP, escalas e formulários psicológicos.",
...
- Sinalize risco de suicídio ou autolesão com destaque imediato.`,
    responseStyle:
      "Linguagem clínica empática e respeitosa. Organize por: estado emocional atual, padrões observados, progresso terapêutico, pontos de atenção. Cite instrumentos aplicados e datas.",
  },
  {
    ...
    specialtyGroup: "SAUDE_MENTAL",
    description:
      "Agente especialista em neuropsicologia. Foco em avaliação cognitiva, baterias neuropsicológicas e reabilitação.",
...
- Não faça inferências diagnósticas sem dados suficientes nas avaliações.`,
    responseStyle:
      "Linguagem técnica neuropsicológica. Organize por domínios cognitivos: atenção, memória, linguagem, funções executivas, habilidades visuoespaciais. Cite instrumentos, normatização e datas.",
  },
  {
    code: "psicopedagogia",
    slug: "psicopedagogia",
    ...
    specialtyGroup: "SAUDE_MENTAL",
    description:
      "Agente especialista em psicopedagogia. Foco em dificuldades de aprendizagem, avaliação e intervenção psicopedagógica.",
...
- Não diagnostique transtornos de aprendizagem sem avaliação completa documentada.`,
    responseStyle:
      "Linguagem técnica com sensibilidade ao contexto educacional. Organize por: perfil de aprendizagem, hipóteses, recursos e dificuldades identificados, sugestões de intervenção.",
  },
  {
    ...
    specialtyGroup: "SAUDE_MENTAL",
    description:
      "Agente especialista em psicologia do desenvolvimento. Foco em marcos desenvolvimentais, ciclo de vida e intervenção precoce.",
...
- Aborde com sensibilidade temas relacionados a atrasos desenvolvimentais com famílias.`,
    responseStyle:
      "Linguagem desenvolvimental com referência a fases e marcos. Organize por domínios: motor, cognitivo, linguagem, socioemocional, adaptativo. Cite instrumentos e compare com marcos normativos.",
  },
  ...
  // ─── Outras especialidades ─────────────────────────────────────────────────
  {
    ...
    description:
      "Agente especialista em fisioterapia. Foco em avaliações funcionais e progressão terapêutica.",
...
- Cite datas das sessões ao referenciar evoluções.`,
    responseStyle:
      "Foco em funcionalidade e progressão. Organize por: avaliação funcional atual, evolução entre sessões, objetivos e próximos passos. Cite escalas e datas.",
  },
  {
    code: "nutricao",
    slug: "nutricao",
    ...
    description:
      "Agente especialista em nutrição clínica. Foco em triagem nutricional e evolução dietética.",
...
- Alergias alimentares e restrições documentadas`,
    ...
    priorityFields: {
      allergies: 1,
      chronicConditions: 2,
      anthropometric_data: 3,
      nutritional_screening: 4,
    },
...
- Destaque condições como diabetes, hipertensão e alergias alimentares.`,
    responseStyle:
      "Foco em dados nutricionais e metabólicos. Organize por: estado nutricional atual, evolução, condições associadas, próximos passos. Cite dados antropométricos e datas.",
  },
];
...
if (require.main === module) {
  main()
    ...
    .finally(() => {
      // eslint-disable-next-line no-empty-function -- swallow disconnect error on cleanup
