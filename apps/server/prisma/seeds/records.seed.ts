...
const RECORDS: Array<{
    ...
    // ─── Ana Beatriz (hipertensão) ────────────────────────────────────────────
    {
        ...
        assessment: 'Hipertensão arterial estágio 1 — diagnóstico. Obesidade grau I. Cefaleia tensional associada.',
    ...
    },
    {
        ...
        objective: 'PA: 132/84 mmHg. FC: 76 bpm. Peso: 71,2 kg. IMC: 26,1 kg/m². Sem efeitos adversos reportados.',
        assessment:
    ...
    // ─── Maria das Graças (idosa, múltiplas comorbidades) ─────────────────────
    {
        ...
        assessment: 'DM2 descompensada (HbA1c 8,9%). HAS descontrolada. AR ativa. Polifarmácia — necessário revisar.',
    ...
    },
    {
        ...
        objective: 'PA: 138/86 mmHg. FC: 78 bpm. Glicemia capilar: 142 mg/dL. HbA1c: 7,8%. Edema de punhos reduzido.',
        assessment: 'DM2 com melhora parcial do controle glicêmico. HAS com resposta inicial à Losartana. AR estável.',
    ...
    },
    {
        ...
        objective: 'PA: 136/84 mmHg. FC: 76 bpm. Glicemia capilar: 118 mg/dL (pós-prandial 2h). Peso estável.',
        assessment:
