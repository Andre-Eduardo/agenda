        ...
        sections: [
          {
            ...
            fields: [
              ...
              },
              {
                id: "expectativas",
                type: "textarea",
                label: "Quais são suas expectativas com a terapia?",
                required: false,
                order: 2,
              },
            ],
          },
          {
            ...
            fields: [
              ...
              },
              {
                id: "depressao",
                type: "number",
                label: "Nível de Tristeza/Depressão (0-10)",
                required: false,
                order: 3,
                validation: { min: 0, max: 10 },
              },
          ...
          },
          {
            ...
            fields: [
              {
                id: "historico_transtornos",
                type: "textarea",
                label: "Histórico familiar de transtornos mentais",
                required: false,
                order: 1,
              },
              {
                id: "relacionamento_familiar",
                type: "select",
                label: "Relacionamento familiar atual",
                required: false,
                order: 2,
                options: [
        ...
        sections: [
          ...
          },
          {
            ...
            fields: [
              ...
              {
                id: "frequencia_sessoes",
                type: "select",
                label: "Frequência de Sessões Sugerida",
                required: false,
                order: 2,
                options: [
