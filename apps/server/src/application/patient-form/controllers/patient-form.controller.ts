...
export class PatientFormController {
    ...
    @ApiOperation({
        ...
        parameters: [entityIdParam('Patient ID', 'patientId'), entityIdParam('Form ID', 'patientFormId')],
    ...
    async getById(
        @RequestActor() actor: Actor,
        @ValidatedParam('patientFormId', patientFormParamSchema.shape.patientFormId.pipe(entityId(PatientFormId)))
