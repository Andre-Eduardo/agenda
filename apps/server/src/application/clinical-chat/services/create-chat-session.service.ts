 ...
 */
@Injectable()
export class CreateChatSessionService implements ApplicationService<CreateChatSessionInput, CreateChatSessionOutput> {
    ...
    private async resolveAgentForMember(memberId: ClinicMemberId): Promise<AiAgentProfile | null> {
        try {
            ...
            const agentConfig = this.agentResolverService.resolveAgentBySpecialty(professional.specialtyNormalized);
