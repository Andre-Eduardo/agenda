...
import { AiAgentProfileDto } from "@application/clinical-chat/dtos";
import { AgentResolutionService } from "@application/clinical-chat/services";
...
export class AgentsController {
  ...
  @ApiOperation({
    ...
    responses: [
      {
        status: 200,
        description: "List of active agent profiles",
  ...
  async resolveAgentForMember(
    ...
    @ValidatedParam(
      ...
      z
        .string()
        .uuid()
        .transform((v) => ClinicMemberId.from(v)),
    )
