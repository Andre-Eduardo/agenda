...
const documentIdSchema = z
  .string()
  .uuid()
  .transform((v) => ClinicalDocumentId.from(v));
...
export class DocumentTemplateController {
    ...
    responses: [
      {
        ...
        type: ClinicalDocumentTemplateDto,
        isArray: true,
      },
    ],
  })
  ...
  @ApiOperation({
    ...
    responses: [
      { status: 200, description: "Template upserted", type: ClinicalDocumentTemplateDto },
    ],
  })
