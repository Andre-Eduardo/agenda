...
class PaymentListItemDto {
    ...
    @ApiProperty({enum: AppointmentPaymentStatus, enumName: 'AppointmentPaymentStatus'}) status: AppointmentPaymentStatus;
...
export class RevenueReportDto {
    ...
    @ApiProperty() filters: {professionalMemberId?: string; paymentMethod?: PaymentMethod; status?: AppointmentPaymentStatus};
