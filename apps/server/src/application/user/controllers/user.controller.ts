...
export class UserController {
    ...
    @Public()
    @Post('/sign-up')
    signUp(@RequestActor() actor: UnauthenticatedActor, @Body() payload: SignUpUserDto): Promise<UserDto> {
    ...
    @Get('/me')
    getCurrentUser(@RequestActor() actor: Actor): Promise<UserDto> {
    ...
    @Get(':id')
    getUser(@RequestActor() actor: Actor, @ValidatedParam('id', getUserSchema.shape.id) id: UserId): Promise<UserDto> {
