...
describe("An update-user service", () => {
  ...
  it("should update a user", async () => {
    ...
    await expect(updateUserService.execute({ actor, payload })).resolves.toEqual(
  ...
  it("should throw an error if the new username is already in use", async () => {
    ...
    jest
      ...
      .mockRejectedValue(new DuplicateUsernameException("Duplicated username"));
  ...
  it("should throw an error if the new email is already in use", async () => {
    ...
    jest
      .spyOn(userRepository, "save")
      .mockRejectedValue(new DuplicateEmailException("Duplicated email"));
