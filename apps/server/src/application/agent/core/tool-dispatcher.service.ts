...
import type { AgentToolCallRecord, ToolContext } from "@application/agent/interfaces";
...
export class ToolDispatcherService {
  ...
  dispatch(toolCalls: LLMToolCall[], context: ToolContext): Promise<DispatchResult[]> {
    return Promise.all(
