...
import {GetAgentMetricsService, AgentMetricsDto} from '../services/get-agent-metrics.service';
...
export class AgentMetricsController {
    ...
    @Get('metrics')
    async getMetrics(@Query() query: Record<string, string>): Promise<AgentMetricsDto> {
