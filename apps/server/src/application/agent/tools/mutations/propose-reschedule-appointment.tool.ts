...
import {
  ...
  type AppointmentRescheduleProposalResult,
} from "@application/agent-proposal/services/create-appointment-reschedule-proposal.service";
...
@Injectable()
export class ProposeRescheduleAppointmentTool implements AgentTool<
  Input,
  AppointmentRescheduleProposalResult
> {
  ...
  execute(input: Input, context: ToolContext): Promise<AppointmentRescheduleProposalResult> {
