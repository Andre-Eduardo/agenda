...
import {CreateAppointmentCancelProposalService, type AppointmentCancelProposalResult} from '../../../agent-proposal/services/create-appointment-cancel-proposal.service';
...
@Injectable()
export class ProposeCancelAppointmentTool implements AgentTool<Input, AppointmentCancelProposalResult> {
    ...
    async execute(input: Input, context: ToolContext): Promise<AppointmentCancelProposalResult> {
