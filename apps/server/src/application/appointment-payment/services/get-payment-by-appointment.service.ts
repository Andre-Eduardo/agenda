...
import {AppointmentPaymentDto} from '../dtos';

export type GetPaymentByAppointmentCommand = {appointmentId: AppointmentId};

@Injectable()
export class GetPaymentByAppointmentService implements ApplicationService<GetPaymentByAppointmentCommand, AppointmentPaymentDto> {
    constructor(
