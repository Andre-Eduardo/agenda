...
import {createCustomerFromIdSchema, createCustomerSchema, createNewCustomerSchema} from '../create-customer.dto';

describe('A CreateCustomerDto', () => {
    it.each([
        {
        ...
        expect(createCustomerSchema.safeParse(payload)).toEqual(
...
describe('A createNewCustomerSchema', () => {
    it.each([
        {
            companyId: CompanyId.generate().toString(),
            name: 'João',
        ...
        expect(createNewCustomerSchema.safeParse(payload)).toEqual(
            expect.objectContaining({
                success: true,
            })
        );
    ...
    it.each<[Record<string, unknown>, ExpectedIssue]>([
        ...
        const result = createNewCustomerSchema.safeParse(payload);
...
describe('A createCustomerFromIdSchema', () => {
    it.each([
        {
            id: PersonId.generate().toString(),
        },
    ])('should accept valid payloads', (payload) => {
        expect(createCustomerFromIdSchema.safeParse(payload)).toEqual(
            expect.objectContaining({
                success: true,
            })
        );
    ...
    it.each<[Record<string, unknown>, ExpectedIssue]>([
        ...
        const result = createCustomerFromIdSchema.safeParse(payload);
