...
function addAddonGrants(limits: PlanLimits, grants: AddonGrants, quantity: number): PlanLimits {
    return {
        docsPerMonth: limits.docsPerMonth + (grants.docsPerMonth !== undefined ? grants.docsPerMonth * quantity : 0),
        ...
        storageHotGb: limits.storageHotGb + (grants.storageHotGb !== undefined ? grants.storageHotGb * quantity : 0),
