...
export class SubscriptionController {
  ...
  @ApiOperation({
    summary:
      "Get current usage for all professionals in a clinic with per-member details (admin/owner only)",
  ...
  @ApiOperation({
    ...
    parameters: [entityIdParam("Clinic ID", "clinicId")],
    responses: [
      { status: 200, description: "Clinic-wide add-on breakdown", type: [MemberActiveAddonsDto] },
    ],
  })
  @Authorize(SubscriptionPermission.VIEW_CLINIC)
