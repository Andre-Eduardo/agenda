...
import {AddonGrantsTotalsDto, ActiveAddonDto} from '@application/subscription/dto/usage.dto';
import {ADDON_CATALOG, AddonCatalogEntry} from '@application/subscription/subscription-plans.config';
import type {AddonDetail} from '@application/subscription/subscription.service';
