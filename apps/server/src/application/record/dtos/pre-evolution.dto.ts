...
import {EvolutionTemplateType, AttendanceType, ClinicalStatusTag, ConductTag} from '@domain/record/entities';
...
export class PreEvolutionDto {
    @ApiProperty({
        ...
        nullable: true,
        description: 'Suggested template type',
    })
    ...
    @ApiProperty({
        ...
        nullable: true,
        description: 'Suggested clinical status',
    })
    ...
    @ApiProperty({
        nullable: true,
        description: 'Original document type (e.g., MEDICAL_REPORT, PRESCRIPTION)',
    })
    ...
    @ApiProperty({
        type: [PreEvolutionFieldDto],
        description: 'Detailed breakdown of extracted fields',
    })
