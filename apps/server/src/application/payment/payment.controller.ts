...
import {ActivateSubscriptionDto} from '@application/payment/dto/activate-subscription.dto';
import {ChangePaymentPlanDto} from '@application/payment/dto/change-plan.dto';
import {PaymentEventDto} from '@application/payment/dto/payment-event.dto';
...
export class PaymentController {
    ...
    async cancelSubscription(@RequestActor() _actor: Actor, @Param('memberId') memberId: string): Promise<void> {
    ...
    async listPayments(@RequestActor() _actor: Actor, @Param('memberId') memberId: string): Promise<PaymentEventDto[]> {
