...
import {ClinicPatientAccess, ClinicPatientAccessId, PatientAccessLevel} from '@domain/clinic-patient-access/entities';
...
@Injectable()
export class ClinicPatientAccessMapper extends MapperWithoutDto<ClinicPatientAccess, ClinicPatientAccessModel> {
