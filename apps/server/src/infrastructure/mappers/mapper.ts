...
export abstract class MapperWithDto<E, ReadModel, D, WriteModel = ReadModel> extends BaseMapper<
    E,
    ReadModel,
    WriteModel
> {
...
export abstract class MapperWithoutDto<E, ReadModel, WriteModel = ReadModel> extends BaseMapper<
    E,
    ReadModel,
    WriteModel
> {}
