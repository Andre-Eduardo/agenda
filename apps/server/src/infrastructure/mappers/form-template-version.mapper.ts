...
export class FormTemplateVersionMapper extends MapperWithoutDto<FormTemplateVersion, FormTemplateVersionModel> {
    ...
    toPersistence(entity: FormTemplateVersion): FormTemplateVersionModel {
        return {
            ...
            definitionJson: entity.definitionJson as unknown as PrismaClient.Prisma.InputJsonValue,
            schemaJson: entity.schemaJson ? (entity.schemaJson as PrismaClient.Prisma.InputJsonValue) : null,
