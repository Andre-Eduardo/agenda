...
import { ClinicalDocumentPrismaRepository } from "@infrastructure/repository/clinical-document.prisma.repository";
import { ClinicalDocumentTemplatePrismaRepository } from "@infrastructure/repository/clinical-document-template.prisma.repository";
import { AiAgentProfilePrismaRepository } from "@infrastructure/repository/ai-agent-profile.prisma.repository";
...
import { ClinicalChatInteractionLogPrismaRepository } from "@infrastructure/repository/clinical-chat-interaction-log.prisma.repository";
import { ClinicalProfilePrismaRepository } from "@infrastructure/repository/clinical-profile.prisma.repository";
...
import { ClinicPrismaRepository } from "@infrastructure/repository/clinic.prisma.repository";
import { DocumentPermissionPrismaRepository } from "@infrastructure/repository/document-permission.prisma.repository";
import { EventPrismaRepository } from "@infrastructure/repository/event.prisma.repository";
import { FormFieldIndexPrismaRepository } from "@infrastructure/repository/form-field-index.prisma.repository";
...
import { DraftEvolutionPrismaRepository } from "@infrastructure/repository/draft-evolution.prisma.repository";
...
const repositories: Provider[] = [
  ...
  {
    provide: ClinicalDocumentTemplateRepository,
    useClass: ClinicalDocumentTemplatePrismaRepository,
  },
];
