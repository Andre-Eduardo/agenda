...
import {InsurancePlanMapper} from '../mappers/insurance-plan.mapper';
import {PrismaProvider} from './prisma/prisma.provider';
import {PrismaRepository} from './prisma.repository';

@Injectable()
export class InsurancePlanPrismaRepository extends PrismaRepository implements InsurancePlanRepository {
    constructor(
