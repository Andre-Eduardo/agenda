    ...
    implements PatientContextSnapshotRepository
{
    ...
    async save(snapshot: PatientContextSnapshot): Promise<void> {
        ...
        const writeData: Prisma.PatientContextSnapshotUncheckedCreateInput = {
            ...
            criticalContext:
                data.criticalContext === null ? Prisma.JsonNull : (data.criticalContext as Prisma.InputJsonValue),
            timelineSummary:
                data.timelineSummary === null ? Prisma.JsonNull : (data.timelineSummary as Prisma.InputJsonValue),
        };
