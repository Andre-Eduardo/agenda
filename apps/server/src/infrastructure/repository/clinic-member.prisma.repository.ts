...
import {ClinicMemberMapper} from '../mappers/clinic-member.mapper';
import {PrismaProvider} from './prisma/prisma.provider';
import {PrismaRepository} from './prisma.repository';

@Injectable()
export class ClinicMemberPrismaRepository extends PrismaRepository implements ClinicMemberRepository {
    constructor(
