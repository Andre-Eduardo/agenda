...
export class AppointmentPrismaRepository extends PrismaRepository implements AppointmentRepository {
  ...
  async search(
    ...
    const where: PrismaClient.Prisma.AppointmentWhereInput = {
      ...
      attendedByMemberId: filter.attendedByMemberId
        ? filter.attendedByMemberId.toString()
        : undefined,
      ...
      startAt:
        filter.dateFrom || filter.dateTo ? { gte: filter.dateFrom, lte: filter.dateTo } : undefined,
