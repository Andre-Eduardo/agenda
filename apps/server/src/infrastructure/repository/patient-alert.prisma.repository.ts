...
import {
  ...
  PatientAlertSearchFilter,
  PatientAlertSortOptions,
} from "@domain/patient-alert/patient-alert.repository";
...
@Injectable()
export class PatientAlertPrismaRepository
  extends PrismaRepository
  implements PatientAlertRepository
{
  constructor(
