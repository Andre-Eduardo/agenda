...
import {DraftEvolution, DraftEvolutionId} from '../../domain/draft-evolution/entities/draft-evolution.entity';
...
import {DraftEvolutionMapper} from '../mappers/draft-evolution.mapper';
import {PrismaProvider} from './prisma/prisma.provider';
import {PrismaRepository} from './prisma.repository';

@Injectable()
export class DraftEvolutionPrismaRepository extends PrismaRepository implements DraftEvolutionRepository {
    constructor(
    ...
    async findByImportedDocumentId(importedDocumentId: ImportedDocumentId): Promise<DraftEvolution | null> {
        const model = await this.prisma.draftEvolution.findUnique({
