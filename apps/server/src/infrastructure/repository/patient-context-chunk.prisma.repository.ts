...
@Injectable()
export class PatientContextChunkPrismaRepository extends PrismaRepository implements PatientContextChunkRepository {
    constructor(
    ...
    async deleteBySource(patientId: PatientId, sourceType: ContextChunkSourceType, sourceId: string): Promise<void> {
