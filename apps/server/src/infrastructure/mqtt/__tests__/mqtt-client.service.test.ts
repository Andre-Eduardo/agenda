...
describe('MqttClientService', () => {
    ...
    describe('onModuleInit', () => {
        it('should connect to MQTT broker', async () => {
            ...
            expect(logger.info).toHaveBeenCalledWith(`Connecting to MQTT broker: ${config.mqtt.brokerUrl}`);
    ...
    describe('publish', () => {
        ...
        it('should throw when not connected', () => {
            expect(() => mqttClientService.publish('test/topic', 'message')).toThrow('MQTT client not connected');
        });
    ...
    describe('subscribe', () => {
        it('should subscribe to topic', async () => {
            ...
            expect(mockClient.subscribe).toHaveBeenCalledWith('test/topic', {qos: 1}, expect.any(Function));
        });
    ...
    describe('onMessage', () => {
        it('should register message handler', async () => {
            ...
            const messageHandler = mockClient.eventHandlers.get('message') as (topic: string, message: Buffer) => void;
