...
export const eventTypes = [userEvents, professionalEvents, appointmentEvents, recordEvents, patientEvents, personEvents, fileEvents, clinicalProfileEvents, patientAlertEvents];
