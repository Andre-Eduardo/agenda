import {FormTemplateVersion, FormTemplateVersionId, FormStatus} from '../form-template-version.entity';
...
function makeVersion(overrides: Partial<ConstructorParameters<typeof FormTemplateVersion>[0]> = {}) {
