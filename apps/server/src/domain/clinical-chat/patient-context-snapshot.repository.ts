...
import type {PatientContextSnapshot, PatientContextSnapshotId} from '@domain/clinical-chat/entities';
...
export interface PatientContextSnapshotRepository {
    ...
    findByPatient(patientId: PatientId, memberId?: ClinicMemberId | null): Promise<PatientContextSnapshot | null>;
