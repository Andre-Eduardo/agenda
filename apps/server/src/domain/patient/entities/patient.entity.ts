...
import type { AllEntityProps, EntityJson, EntityProps, CreateEntity } from "@domain/@shared/entity";
import { Person, PersonId, PersonType } from "@domain/person/entities/person.entity";
import {
  PatientCreatedEvent,
  PatientChangedEvent,
  PatientDeletedEvent,
} from "@domain/patient/events";
import type { DocumentId } from "@domain/@shared/value-objects";
...
export class Patient extends Person {
  ...
  change(props: UpdatePatient): void {
    ...
    if (props.insuranceCardNumber !== undefined)
      this.insuranceCardNumber = props.insuranceCardNumber;
