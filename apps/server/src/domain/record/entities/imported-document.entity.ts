import {AggregateRoot, type AllEntityProps, type EntityJson, type CreateEntity} from '@domain/@shared/entity';
...
import type {FileId} from '@domain/record/entities/file.entity';
