...
import type { EntityProperties } from "@domain/@shared/entity/entity.types";
...
import { ClinicalDocumentGeneratedEvent } from "@domain/clinical-document/events";
import type { ClinicalDocumentTemplateId } from "@domain/clinical-document/entities/clinical-document-template.entity";
...
export type CreateClinicalDocument = Nullish<
  Omit<AllEntityProps<ClinicalDocument>, EntityProperties | "status">
>;
