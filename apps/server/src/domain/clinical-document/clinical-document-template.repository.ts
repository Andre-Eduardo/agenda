...
import type {ClinicalDocumentTemplate, ClinicalDocumentTemplateId, ClinicalDocumentType} from './entities';
...
export interface ClinicalDocumentTemplateRepository {
    ...
    findByClinicAndType(clinicId: ClinicId, type: ClinicalDocumentType): Promise<ClinicalDocumentTemplate | null>;
