...
import {DocumentEntityType} from '@domain/document-permission/entities/document-entity-type';
import {DocumentPermissionGrantedEvent, DocumentPermissionChangedEvent} from '@domain/document-permission/events';
