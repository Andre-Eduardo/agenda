import {AggregateRoot, type AllEntityProps, type EntityJson, type EntityProps} from '@domain/@shared/entity';
import {EntityId} from '@domain/@shared/entity/id';
import {InvalidInputException} from '@domain/@shared/exceptions';
import type {DocumentId, Phone} from '@domain/@shared/value-objects';
import {PersonDeletedEvent} from '@domain/person/events';
...
export class Person extends AggregateRoot<PersonId> {
    ...
    protected validate(...fields: Array<keyof PersonProps>): void {
        ...
        if (
            (fields.length === 0 || fields.includes('gender')) &&
            this.gender !== null &&
