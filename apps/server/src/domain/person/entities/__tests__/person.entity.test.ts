...
describe("A person", () => {
  ...
  describe("on create", () => {
    it.each([
      [
        { name: "", profiles: new Set([PersonProfile.CUSTOMER]) },
        "Person name must be at least 1 character long.",
      ],
      [
        { name: "", profiles: new Set([PersonProfile.EMPLOYEE]) },
        "Person name must be at least 1 character long.",
      ],
      [
        { companyName: "company", personType: PersonType.NATURAL },
        "Only legal persons can have a company name.",
      ],
      [
        { gender: Gender.MALE, personType: PersonType.LEGAL },
        "Only natural persons can have a gender.",
      ],
